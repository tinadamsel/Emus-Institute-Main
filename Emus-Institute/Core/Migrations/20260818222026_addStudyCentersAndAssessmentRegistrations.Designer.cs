...
namespace Core.Migrations
{
    ...
    [Migration("20260818222026_addStudyCentersAndAssessmentRegistrations")]
    partial class addStudyCentersAndAssessmentRegistrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.CbtAttempt", b =>
                {
                    ...
                    b.ToTable("CbtAttempts");
                });

            modelBuilder.Entity("Core.Models.CbtQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.CbtStudentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CbtAttemptId")
                        .HasColumnType("int");

                    b.Property<int>("CbtQuestionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CbtAttemptId");

                    b.HasIndex("CbtQuestionId");

                    b.ToTable("CbtStudentAnswers");
                });

            modelBuilder.Entity("Core.Models.CbtTest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MarkPerQuestion")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Core.Models.Department", b =>
                {
                    ...
                    b.Property<bool>("IsUnderScholarship")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Models.EvaluationDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("HighSchoolCompletionCertificate")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("WAECScratchCard")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Models.LiveSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.StaffEvaluationDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("EvaluationReminderSentCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.CbtStudentAnswer", b =>
                {
                    b.HasOne("Core.Models.CbtAttempt", "CbtAttempt")
                        .WithMany("Answers")
                        .HasForeignKey("CbtAttemptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.CbtQuestion", "CbtQuestion")
                        .WithMany()
                        .HasForeignKey("CbtQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CbtAttempt");

                    b.Navigation("CbtQuestion");
                });
